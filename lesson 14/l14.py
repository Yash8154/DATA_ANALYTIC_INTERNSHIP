# -*- coding: utf-8 -*-
"""
Created on Tue Jul 19 17:08:31 2022
...
df.to_sql("atable",conn)

#reading the data from the table

rconn=sql.connect("states.db")

read=pd.read_sql("SELECT * FROM atable",rconn)

read1=pd.read_sql("SELECT * FROM atable WHERE Year==1956",rconn)
